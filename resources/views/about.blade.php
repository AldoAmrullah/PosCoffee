        ...
        <div class="row mb-5">
            ...
            <div class="col-lg-9 mt-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Awal mula Coffe Shop Ini</h5>
                        <p class="card-text">Pak Budi, seorang pecinta kopi, memiliki impian membuka coffee shop istimewa. Setelah mempelajari kopi secara mendalam, ia mencari lokasi strategis dan menemukan ruang kosong di pusat kota. Dengan desainer interior, ia menciptakan suasana yang hangat. Pak Budi memilih biji kopi berkualitas tinggi dan bekerja langsung dengan petani kopi. Pada pembukaan, coffee shopnya dengan aroma kopi yang harum menjadi tempat favorit. Pak Budi mengadakan acara komunitas dan menjadi anggota aktif. Coffee shop Pak Budi sukses dan dihormati di komunitasnya.</p>
                    </div>
                </div>
            </div>
            <!-- End Content-->
